...
public class AddCreditActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        switch (v.getId()) {
            case R.id.btn_credit:
                ...
                if (!mCredit.getText().toString().isEmpty()) {
                    ...
                    alertDialog.setMessage("Jumlah hutang oleh '" + customerName + "' adalah Rm " + m.money(credit + saldo));
    ...
    private DatePickerDialog.OnDateSetListener pickerListener = new DatePickerDialog.OnDateSetListener() {
        ...
        public void onDateSet(DatePicker view, int selectedYear,
            ...
            day   = selectedDay;
            //setMonth();
            dateOfCredit.setText(new StringBuilder().append(day).append("/").append(month + 1).append("/")
                    .append(year).append(" "));
        }
    };
