...
public class ListTransactionActivity extends AppCompatActivity implements AdapterView.OnItemLongClickListener{
    ...
    private void showDeleteDialogConfirmation(final Transaction clickedTransaction) {
        ...
        alertDialogBuilder.setMessage("Adakah yakin ingin hapuskan transaksi ini ?");
        ...
        alertDialogBuilder.setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                dialog.dismiss();
                Toast.makeText(ListTransactionActivity.this, "Berjaya di Hapuskan", Toast.LENGTH_SHORT).show();
            }
        });
