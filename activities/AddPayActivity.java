...
//        getSupportActionBar().hide();
        ...
        if(mListTransactions != null && !mListTransactions.isEmpty()) {
            ...
            if (saldo1 == 0) {
                ...
                alertDialog.setMessage("Peminjam ini belum mempunyai hutang");
            ...
            alertDialog.setTitle("Pemberitahuan!");
            // Setting Dialog Message
            alertDialog.setMessage("Peminjam ini belum mempunyai kegiatan transaksi");
            // Setting Icon to Dialog
            alertDialog.setIcon(R.drawable.info20);
            // Setting OK Button
            alertDialog.setButton("OK", new DialogInterface.OnClickListener() {
            ...
            case R.id.btn_pay:
                if (!mPay.getText().toString().isEmpty()) {
                    ...
                    if (total >= 1) {
                        ...
                        alertDialog.setTitle("Pemberitahuan!");
                        // Setting Dialog Message
                        alertDialog.setMessage("Wang dikembalikan kepada peminjsm '" + customerName + "' adalah Rm " + m.money(total) +" dan hutang HABIS!");
                        // Setting Icon to Dialog
                        alertDialog.setIcon(R.drawable.info20);
                        // Setting OK Button
                        alertDialog.setButton("OK", new DialogInterface.OnClickListener() {
                        ...
                        alertDialog.setTitle("Pemberitahuan!");
                        // Setting Dialog Message
                        alertDialog.setMessage(customerName + "' masih mempunyai hutang sebanyak Rm " + m.money(total2));
                        // Setting Icon to Dialog
                        alertDialog.setIcon(R.drawable.info20);
                        // Setting OK Button
                        alertDialog.setButton("OK", new DialogInterface.OnClickListener() {
                        ...
                        alertDialog.setTitle("Pemberitahuan!");
                        // Setting Dialog Message
                        alertDialog.setMessage("Hutang peminjam '" + customerName + "' HABIS DIBAYAR!");
                        // Setting Icon to Dialog
                        alertDialog.setIcon(R.drawable.info20);
                        // Setting OK Button
                        alertDialog.setButton("OK", new DialogInterface.OnClickListener() {
