...
public class Donation extends AppCompatActivity {
    ...
    final String get_token = "http://bed34fb4.ngrok.io/BraintreePayments/main.php";
    final String send_payment_details = "http://bed34fb4.ngrok.io/BraintreePayments/checkout.php";
    String token, amount;
        ...
        if (requestCode == REQUEST_CODE) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                if (!etAmount.getText().toString().isEmpty()) {
                    ...
                    Toast.makeText(Donation.this, "Please enter a valid amount.", Toast.LENGTH_SHORT).show();
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (response.contains("Successful")) {
                            Toast.makeText(Donation.this, "Transaction ", Toast.LENGTH_LONG).show();
                        }
                        else {
                            Toast.makeText(Donation.this, "Transaction successful", Toast.LENGTH_LONG).show();
